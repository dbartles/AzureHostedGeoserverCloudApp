...
## A full stack (database, server + website) configuration of an open layers based public web map. Hosted on a Liux VM running cloud native geoserver in Microsoft Azure Cloud
