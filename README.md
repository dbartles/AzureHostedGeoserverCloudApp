# How to build an open-source web GIS system
## A full stack (database, server + website) configuration of an open layers based public web map. Hosted on a Linux VM running cloud native geoserver in Microsoft Azure Cloud
...
On the next page accept the default to create a new public IP address. 
